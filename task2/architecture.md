...
หลัง cache คาดว่าค่า LLM อยู่ที่ประมาณ **$330–400 ต่อเดือน** ต้องยืนยันด้วย traffic จริงก่อนขึ้น production

ด้านเวลา `guardrail + embed + search` ประมาณ 80 ms ที่เหลือเป็นการเรียก LLM จึงควรตอบแบบ streaming ให้ผู้ใช้เห็นตัวอักษรแรกภายใน 1 วินาที ส่วน cache hit ควรตอบได้ในหลักสิบมิลลิวินาที
